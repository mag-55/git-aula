...
def validarUsuario(usuario):
    ...
    if longitud == False:
        messagebox.showinfo(
            title="ATENCION!", message="El nombre de usuario debe tener un largo de entre 6 y 12 caracteres")
        usuario[7].focus()
    elif sinSimbolos == False:
        messagebox.showinfo(
            title="ATENCION!", message="El nombre de usuario debe tener unicamente letras y numeros")
        usuario[7].focus()
    else:
...
def validarClave(clave):
    ...
    if longitud == False:
        messagebox.showinfo(
            title="ATENCION!", message="La clave debe tener un minimo de 8 caracteres")
    elif sinSimbolos == False:
        messagebox.showinfo(
            title="ATENCION!", message="La clave debe tener solo letras y/o números sin espaios u otros simbolos")
    elif clave[8].get().isalpha() == False and clave[8].get().isdigit() == False and clave[8].get().islower() == False and clave[8].get().isupper() == False:
        print("OK CLAVE")
    else:
        messagebox.showinfo(
            title="ATENCION!", message="La clave debe ser alfanumerica y tener almenos una letra mayúscula")
...
def comparar_Us_Cl(lista):
    ...
    if usuario == clave:
        messagebox.showinfo(
            title="ATENCION!", message="EL USUARIO Y LA CLAVE NO PUEDEN SER IGUALES")
...
def compararClaves(lista):
    ...
    if clave1 != clave2:
        messagebox.showinfo(
            title="ATENCION!", message="LA CLAVE Y LA CONFIMACION DE ESTA DEBEN SER IGUALES")
